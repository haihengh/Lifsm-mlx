...
// ────────────────────────────────────
// The file is a UTF-8 text file generated alongside the .finchmoe model by
// finchmoe_convert.py.  It has two sections separated by the line
// "### special ###":
//
...
// Path convention
// ───────────────
// For a model at /path/to/model.finchmoe the tokenizer expects a vocabulary at
//   /path/to/model.tiktoken
// This is produced automatically by finchmoe_convert.py and is required for
...
//   /path/to/model.finchmoe → /path/to/model.tiktoken
