...
// ─────────────────────────────────────────────────────────────────────────────
// Minimal command-line smoke-test for AeroMoE.
//
// Usage:
//   aeromoe_generate <model.aeromoe> [prompt_token ...] [options]
//
// Options:
...
//
// Build:
//   cmake -B build -DCMAKE_BUILD_TYPE=Release && cmake --build build -t aeromoe_generate
// ─────────────────────────────────────────────────────────────────────────────
...
static void usage(const char* argv0) {
    fprintf(stderr,
        "Usage: %s <model.aeromoe> [--max-tokens N] [--temperature F]\n"
        "          [--top-p F] [--seed N] [--verbose] <token_id> ...\n\n"
        "Example (Qwen3 greeting test):\n"
        "  %s model.aeromoe --max-tokens 32 1 9906 11\n"
